...
const flagshipOrder: Omit<Flagship, "fig">[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { k: "DC drop screen", v: "19.9 mV", note: "worst driver distribution, 50 mV bound" },
  ...
  },
  {
    ...
    params: [
      { k: "Language", v: "Rust — exact integer clearance", active: true },
    ...
    metrics: [
      ...
      { k: "New DRC", v: "no clearance, short or hole", note: "3–7 starved thermals remain per board" },
